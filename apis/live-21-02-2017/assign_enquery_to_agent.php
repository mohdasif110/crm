		...
		if($numrow>0){
			...
			*/
			...
			if($getQueryData['enquiry_assign_to_agent_id']==0){
				...
				$update			=	"update crm_enquiry_capture set  enquiry_assign_to_agent_id='".$userID."', enquiry_assign_by_to_agent_id='".$assign_by."', agent_assign_status='1' where id='".$enqueryID."'";	
				...
				$update			=	"update crm_enquiry_capture set  enquiry_assign_to_agent_id='', enquiry_assign_by_to_agent_id='', agent_assign_status='0' where id='".$enqueryID."'";	
				$updateQuery 	=	mysql_query($update);	
