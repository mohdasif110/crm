...
function getLeadMeetingData($enquiry_id = NULL) {
	...
	$select_meeting_data = 'SELECT * FROM `lead_meeting` WHERE enquiry_id = ' . $enquiry_id . ' ORDER BY `id` DESC LIMIT 1';
...
function getLeadSiteVisitData($enquiry_id = null) {
	...
	$select_visit_data = 'SELECT * FROM `site_visit` WHERE enquiry_id = ' . $enquiry_id . ' ORDER BY `id` DESC LIMIT 1';
