			...
			leadsService.getLeadStatus(enquiry_id).then(function (res){
				...
				if(res.data){
					...
					if( parseInt(lead_data.disposition_status_id) === 3 ){
						$scope.lead_status_data.event_date  = lead_data.meeting.meeting_date;
						$scope.lead_status_data.event_time  = lead_data.meeting.meeting_time;
						$scope.lead_status_data.project		= lead_data.meeting.project_name;
						$scope.lead_status_data.status		= 'Meeting';
					}
					else if ( parseInt(lead_data.disposition_status_id) === 6){
						$scope.lead_status_data.event_date  = lead_data.site_visit.site_visit_date;
						$scope.lead_status_data.event_time  = lead_data.site_visit.site_visit_time;
						$scope.lead_status_data.project		= lead_data.site_visit.project_name;
