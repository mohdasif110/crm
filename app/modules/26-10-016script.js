...
//					alert('edit lead controller initiatated');
//				 }
		})
		.when('/lead-enqueries', {
         ...
         */
        app.controller('mainAppCtrl', function ($scope,application_blocks,appUrls,appLayout,$location,AuthService,baseUrl,Session,$http){
